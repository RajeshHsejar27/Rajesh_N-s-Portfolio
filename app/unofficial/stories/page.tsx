...
const timelineData = [
  ...
  },
  {
    ...
    location: 'College',
    description: 'A busy year with learning daily- actually commuting more than learning a day. Adapted to the hard lifestyle of going long distance daily and not ate properly. Was in depression. Yet did not give up on myself. Stayed alone & focused on learning & spending free time productively. Prepared sometimes for placement too. Started to take part in hackathons and coding competitions (that did not go very well, but got some experience). Missed a lot in college life but did not regret it. This is the year where I worked on full-fledged fullstack web development with Udemy learning and parallel localhost implementation and rigorous design iterations. I learned a lot in web technologies and how they are implemented and used in modern web applications. Although my knowledge back then was basic even with popular library like React and MERN stack, still, it gave me confidence that I am too capable of implementing web apps with concise design, purposeful and logical concept & secure, creative practical features. This is the year where I deployed an Ecommerce web app successfully with a Dark Mystic theme & artifact trading system. Along with this I deployed small small cute web projects involving just backend functionalities covering the API concepts that I newly learned back then',
